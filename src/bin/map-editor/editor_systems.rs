                ...
                CollapsingHeader::new("Heightmap settings")
                    ...
                    .show(ui, |ui| {
                        ...
                        if ui.button("Save map").clicked() {
                            ...
                            let mut file = std::fs::File::create("mymap.map").unwrap();
...
fn draw_circle_decal(stride: u32, center: Vec2, buffer: &mut [u8], hm_settings: &HmEditorSettings, map_size: u32) {
...
fn draw_square_decal(stride: u32, center: Vec2, buffer: &mut [u8], hm_settings: &HmEditorSettings, map_size: u32) {
